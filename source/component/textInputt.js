...
import {
  ...
  TextInput,
  View,
  StyleSheet,TouchableHighlight,ScrollView ,KeyboardAvoidingView
} from 'react-native'
...
export default class extends Component{
	...
	render(){
		var data=Data[this.state.index]
		return(
			<ScrollView style={{flex:1}}>
				<View style={{flexDirection:'row'}}>
					<TouchableHighlight underlayColor="#ddd" onPress={()=>{this.pre()}}>
					<Text>上一条</Text>
					</TouchableHighlight >
					<TouchableHighlight underlayColor="#ddd" onPress={()=>{this.next()}}>
						<Text>下一条</Text>
					</TouchableHighlight >
				...
				{data.render()}
				<View style={{height:300,width:200}}></View>
